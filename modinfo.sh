...
grub_target_cc_version='gcc-7 (Ubuntu 7.3.0-29ubuntu1) 7.3.0'
...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/7/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.02"
grub_package="grub"
grub_package_string="GRUB 2.02+dfsg1-5ubuntu8.3"
grub_package_version="2.02+dfsg1-5ubuntu8.3"
